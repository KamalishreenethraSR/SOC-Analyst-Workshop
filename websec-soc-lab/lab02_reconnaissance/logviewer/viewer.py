...
def dashboard():
    ...
    return render_template_string(HTML_TEMPLATE, lab_title="Lab 02 — Reconnaissance", total_reqs=total_reqs, total_alerts=total_alerts, total_blocked=total_blocked, events=events)
