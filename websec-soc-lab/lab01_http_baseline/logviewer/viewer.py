...
def dashboard():
    ...
    return render_template_string(HTML_TEMPLATE, lab_title="Lab 01 — HTTP Baseline", total_reqs=total_reqs, total_alerts=total_alerts, total_blocked=total_blocked, events=events)
