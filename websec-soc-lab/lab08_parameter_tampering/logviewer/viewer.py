...
def dashboard():
    ...
    return render_template_string(HTML_TEMPLATE, lab_title="Lab 08 — Parameter Tampering", total_reqs=total_reqs, total_alerts=total_alerts, total_blocked=total_blocked, events=events)
